...
<?php } ?>
  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/bt_outside/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      ...
      <td>
	  <div class="button_cp">
	  <div class="cart_cp"><input type="button" value="<?php echo $button_cart; ?>" onclick="boss_addToCart('<?php echo $product['product_id']; ?>');" class="btn btn-cart" /></div>
	  <div class="remove"><a title="<?php echo $button_remove; ?>" href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/removex.png" alt="<?php echo $button_remove; ?>" /></a></div>
	  </div>
	  <div class="wishlist"><a onclick="boss_addToWishList('<?php echo $product['product_id']; ?>');"><i class="fa fa-plus"></i><?php echo $this->language->get('button_wishlist'); ?></a></div>
	  </td>
      <?php } ?>
    </tr>
  ...
  <div class="buttons">
    <div class="right"><br/><a href="<?php echo $continue; ?>" class="btn"><?php echo $button_continue; ?></a></div>
  </div>
  <?php } else { ?>
  ...
  <?php } ?>
  <?php echo $content_bottom; ?></div><?php echo $column_right; ?></div></div>
<?php echo $footer; ?>