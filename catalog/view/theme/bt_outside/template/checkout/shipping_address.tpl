...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      ...
      <tr><td><input type="text" class="form-control" name="postcode" value="<?php echo $postcode; ?>" class="large-field" /></td>
    </tr>
    <tr>
...
<div class="buttons">
  <div class="left">
    <span class="button_fr_ip"><input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" class="btn" /></span>
  </div>
</div>
