  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="right" style="padding-left:20px;padding-right:20px;text-align:center;width:70px"><a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
      </tr>
      <?php } ?>
