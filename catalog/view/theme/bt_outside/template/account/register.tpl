...
<div class="row">
  ...
  <p style="margin-bottom:20px;"><?php echo $text_account_already; ?></p>
  <form class="register"action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      <table class="form">
        <tr>
          <td  class="subscribe" style="display:inline"><?php echo $entry_newsletter; ?></td>
         <td style="display:inline" class="input"><?php if ($newsletter) { ?>
            <input type="radio" name="newsletter" value="1" checked="checked" />
            <span style="margin-right:25px;"><?php echo $text_yes; ?></span>
    ...
    <?php if ($text_agree) { ?>
    <div class="buttons" style="width:100%;overflow:hidden;float:left;">
      <div class="left">
        <?php if ($agree) { ?>
        <input type="checkbox" name="agree" value="1" checked="checked" />
        <?php } else { ?>
        <input type="checkbox" name="agree" value="1" />
        <?php } ?>&nbsp;<span><?php echo $text_agree; ?></span></br>
        <span class="button_fr_ip"><input type="submit" value="<?php echo $button_continue; ?>" class="btn" style="margin-top:34px" /></span>
      </div>
    </div>
    <?php } else { ?>
    <div class="buttons">
