...
<div>
	...
	<table class="form">
		...
		<?php $html = json_decode($menu['content_text'], true); ?>
		...
		<tr id="megamenutype-html" class="megamenutype">
			...
			<td>
				<div id="language-html-<?php echo $module_row; ?>" class="htabs languagehtmltabs">
					<?php foreach ($languages as $language) { ?>
					<a href="#tab-language-html-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
					<?php } ?>
				</div>
				<?php foreach ($languages as $language) { ?>
				<div id="tab-language-html-<?php echo $language['language_id']; ?>">
				<textarea type="text" name="megamenu[content_text][<?php echo $language['language_id'];?>]"  size="50"><?php echo $html[$language['language_id']];?></textarea>
...
<?php foreach ($languages as $language) { ?>
CKEDITOR.replace('megamenu[content_text][<?php echo $language['language_id'];?>]', {
