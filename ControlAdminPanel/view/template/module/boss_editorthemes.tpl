		...
		<div class="content">
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<div class="htabs" id="mainTabs">
					...
					<a href="#customfooter"><?php echo 'Footer Setting'; ?></a>
				</div> <!-- End .mainTabs -->
				
				<!-- CUSTOM Footer -->
				<div id="customfooter" class="htabs-content">
					
					<div id="footer_tab" class="vtabs">
						<a href="#tab_footer_1"><?php echo 'About us'; ?></a>
						<a href="#tab_footer_2"><?php echo 'Contact us'; ?></a>
						<a href="#tab_footer_7"><?php echo 'Follow us'; ?></a>
						<a href="#tab_footer_3"><?php echo 'Quick Link'; ?></a>
						<a href="#tab_footer_5"><?php echo 'Payment link'; ?></a>
						<a href="#tab_footer_6"><?php echo 'Powered by'; ?></a>
					</div>
					
					<div id="tab_footer_1" class="vtabs-content">
						<table class="form">
							<tr>
								<td><?php echo 'Status:'; ?></td>
								<td><select name="footer_about[status]">
							...
							<tr>
								...
								<td><select name="footer_about[image_status]">
								...
								<div class="image"><img src="<?php echo $about_image; ?>" alt="" id="thumb-about" />
								  <input type="hidden" name="footer_about[image_link]" value="<?php echo isset($footer_about['image_link'])?$footer_about['image_link']:''; ?>" id="image-about" />
								  <br />
								  <a onclick="image_upload('image-about', 'thumb-about');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-about').attr('src', '<?php echo $no_image; ?>'); $('#image-about').attr('value', '');"><?php echo $text_clear; ?></a></div>
								</td>	
							</tr>
							<tr>
								<td><?php echo 'Image Link'; ?></td>
								<td>
									<input size=50 type="text" name="footer_about[image_url]" value="<?php echo isset($footer_about['image_url'])?$footer_about['image_url']:'#'; ?>" />
								</td>
							</tr>
						</table>
						<div id="aboutus-lang" class="htabs">
							<?php foreach ($languages as $language) { ?>
							<a href="#tab-aboutus-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
							<?php } ?>
						</div>
						<?php foreach ($languages as $language) { ?>
						<div id="tab-aboutus-<?php echo $language['language_id']; ?>" class="htabs-content">
							<table class="form">
							<tbody>
								<tr>
									<td><?php echo 'About Store Title:'; ?></td>
									<td>
										<input type="text" name="footer_about[about_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_about['about_title'][$language['language_id']])?$footer_about['about_title'][$language['language_id']]:'About Us Title'; ?>">
									</td>
								</tr>
								<tr>
									<td><?php echo 'About Store Content:'; ?></td>
									<td><textarea name="footer_about[about_content][<?php echo $language['language_id']; ?>]" id="boss-aboutus-ckeditor<?php echo $language['language_id']; ?>" rows="10" cols="50" ><?php echo isset($footer_about['about_content'][$language['language_id']])?$footer_about['about_content'][$language['language_id']]:''; ?></textarea></td>
								</tr>
							</tbody>
							</table>
						</div>
					...
					<div id="tab_footer_3" class="vtabs-content">
						<table class="form">
							<tr>
								<td><?php echo 'Status:'; ?></td>
								<td><select name="footer_link[status]">
						...
						<div id="quicklink-lang" class="htabs">
							<?php foreach ($languages as $language) { ?>
							<a href="#tab-quicklink-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
							<?php } ?>
						</div>
						<?php foreach ($languages as $language) { ?>
						<div id="tab-quicklink-<?php echo $language['language_id']; ?>" class="htabs-content">
							<table class="form">
							<tbody>
								<tr>
									<td><?php echo 'Title:'; ?></td>
									<td>
										<input type="text" name="footer_link[link_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_link['link_title'][$language['language_id']])?$footer_link['link_title'][$language['language_id']]:'Quick Link'; ?>">
									</td>
								</tr>
								<tr>
									<td><?php echo 'Content:'; ?></td>
									<td><textarea name="footer_link[link_content][<?php echo $language['language_id']; ?>]" id="boss-quicklink-ckeditor<?php echo $language['language_id']; ?>" rows="10" cols="50" ><?php echo isset($footer_link['link_content'][$language['language_id']])?$footer_link['link_content'][$language['language_id']]:''; ?></textarea></td>
								</tr>
							</tbody>
							</table>
						</div>
					...
					<div id="tab_footer_2" class="vtabs-content">
						<table class="form">
							<tr>
								<td><?php echo 'Status:'; ?></td>
								<td><select name="footer_contact[status]">
						...
						<div id="contactus-lang" class="htabs">
							<?php foreach ($languages as $language) { ?>
							<a href="#tab-contactus-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
							<?php } ?>
						</div>
						<?php foreach ($languages as $language) { ?>
						<div id="tab-contactus-<?php echo $language['language_id']; ?>" class="htabs-content">
							<table class="form">
							<tbody>
								<tr>
									<td><?php echo 'About Store Title:'; ?></td>
									<td>
										<input type="text" name="footer_contact[contact_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_contact['contact_title'][$language['language_id']])?$footer_contact['contact_title'][$language['language_id']]:'About Us Title'; ?>">
									</td>
								</tr>
								<tr>
									<td><?php echo 'About Store Content:'; ?></td>
									<td><textarea name="footer_contact[about_content][<?php echo $language['language_id']; ?>]" id="boss-contactus-ckeditor<?php echo $language['language_id']; ?>" rows="10" cols="50" ><?php echo isset($footer_contact['about_content'][$language['language_id']])?$footer_contact['about_content'][$language['language_id']]:''; ?></textarea></td>
								</tr>
							</tbody>
							</table>
						</div>
					...
					<div id="tab_footer_5" class="vtabs-content" style="display: block;">
						<?php $text_url = 'Url:'; ?>
						<table class="form">
							<tr>
								<td><?php echo 'Payment Status:'; ?></td>
								<td><select name="footer_payment[status]">
							...
							<tr>
								<td><?php echo 'Visa'; ?></td>
								<td><input type="checkbox" name="footer_payment[visa_status]" <?php echo (isset($footer_payment['visa_status'])&&$footer_payment['visa_status'])?'checked="checked"':'';?> />Show
								<img alt="Visa" src="../image/data/bt_outside/visa.png"/>
								<?php echo $text_url; ?><input type="text" name="footer_payment[visa_link]" value="<?php echo isset($footer_payment['visa_link'])?$footer_payment['visa_link']:''; ?>" /></td>
							</tr>
							<tr>
								<td><?php echo 'Master Card'; ?></td>
								<td><input type="checkbox" name="footer_payment[master_status]" <?php echo (isset($footer_payment['master_status'])&&$footer_payment['master_status'])?'checked="checked"':'';?> />Show
								<img alt="Master Card" src="../image/data/bt_outside/master.png"/>
								<?php echo $text_url; ?><input type="text" name="footer_payment[master_link]" value="<?php echo isset($footer_payment['master_link'])?$footer_payment['master_link']:''; ?>" /></td>
							</tr>
							<tr>
								<td><?php echo 'American Express'; ?></td>
								<td><input type="checkbox" name="footer_payment[merican_status]" <?php echo (isset($footer_payment['merican_status'])&&$footer_payment['merican_status'])?'checked="checked"':'';?> />Show
								<img alt="American" src="../image/data/bt_outside/american.png"/>
								<?php echo $text_url; ?><input type="text" name="footer_payment[merican_link]" value="<?php echo isset($footer_payment['merican_link'])?$footer_payment['merican_link']:''; ?>" /></td>
							</tr>
							<tr>
								<td><?php echo 'Paypal'; ?></td>
								<td><input type="checkbox" name="footer_payment[paypal_status]" <?php echo (isset($footer_payment['paypal_status'])&&$footer_payment['visa_status'])?'checked="checked"':'';?> />Show
								<img alt="Paypal" src="../image/data/bt_outside/paypal.png"/>
								<?php echo $text_url; ?><input type="text" name="footer_payment[paypal_link]" value="<?php echo isset($footer_payment['paypal_link'])?$footer_payment['paypal_link']:''; ?>" /></td>
							</tr>
							
							<tr>
								<td><?php echo 'Skrill'; ?></td>
								<td><input type="checkbox" name="footer_payment[skrill_status]" <?php echo (isset($footer_payment['skrill_status'])&&$footer_payment['skrill_status'])?'checked="checked"':'';?> />Show
								<img alt="Skrill" src="../image/data/bt_outside/skrill.png"/>
								<?php echo $text_url; ?><input type="text" name="footer_payment[skrill_link]" value="<?php echo isset($footer_payment['skrill_link'])?$footer_payment['skrill_link']:''; ?>" /></td>
							</tr>
						</table>
					</div>
					
					<div id="tab_footer_7" class="vtabs-content" style="display: block;">
						<table class="form">
							<tbody>
							<tr>
								<td><?php echo 'Social Status:'; ?></td>
								<td><select name="footer_social[status]">
							...
							<tr>
								...
								<td>
								<?php foreach ($languages as $language) { ?>
								<input size=50 type="text" name="footer_social[title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($footer_social['title'][$language['language_id']])?$footer_social['title'][$language['language_id']]:''; ?>"/><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <br />
								<?php } ?>
								</td>
							</tr>
							<tr>
								...
								<td>
								<input type="text" name="footer_social[face_url]" value="<?php echo isset($footer_social['face_url'])?$footer_social['face_url']:''; ?>"/></td>
							</tr>
							<tr>
								<td><?php echo 'Twitter'; ?></td>
								<td>
								<input type="text" name="footer_social[twitter_url]" value="<?php echo isset($footer_social['twitter_url'])?$footer_social['twitter_url']:''; ?>"/></td>
							</tr>
							<tr>
								<td><?php echo 'Google Plus'; ?></td>
								<td>
								<input type="text" name="footer_social[google_url]" value="<?php echo isset($footer_social['google_url'])?$footer_social['google_url']:''; ?>"></td>
							</tr>
							<tr>
								<td><?php echo 'Pinterest'; ?></td>
								<td>
								<input type="text" name="footer_social[pinterest_url]" value="<?php echo isset($footer_social['pinterest_url'])?$footer_social['pinterest_url']:''; ?>"></td>
							</tr>
							<tr>
								<td><?php echo 'Vimeo'; ?></td>
								<td>
								<input type="text" name="footer_social[vimeo_url]" value="<?php echo isset($footer_social['vimeo_url'])?$footer_social['vimeo_url']:''; ?>"></td>
							</tr>
							<tr>
								<td><?php echo 'Rss Feed'; ?></td>
								<td>
								<input type="text" name="footer_social[rss_url]" value="<?php echo isset($footer_social['rss_url'])?$footer_social['rss_url']:''; ?>"></td>
							</tr>
					...
					<div id="tab_footer_6" class="vtabs-content" style="display: block;">
						<div id="powered-lang" class="htabs">
							<?php foreach ($languages as $language) { ?>
							<a href="#tab-powered-<?php echo $language['language_id']; ?>"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a>
							<?php } ?>
						</div>
						<?php foreach ($languages as $language) { ?>
						<div id="tab-powered-<?php echo $language['language_id']; ?>" class="htabs-content">
							<table class="form">
							<tbody>
								<tr>
									<td><?php echo 'Powered Content:'; ?></td>
									<td><textarea name="footer_powered[<?php echo $language['language_id']; ?>]" id="boss-powered-ckeditor<?php echo $language['language_id']; ?>" rows="10" cols="50" ><?php echo isset($footer_powered[$language['language_id']])?$footer_powered[$language['language_id']]:''; ?></textarea></td>
								</tr>
							</tbody>
							</table>
						</div>
									...
									<div class="box">
										...
										<div class="content">
											<table class="form">
												...
												<tr>
													<td><?php echo $entry_show_animate; ?></td>
													<td class="left">
														<select name="b_show_animate">
															<?php if ($b_show_animate) { ?>
																<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
																<option value="0"><?php echo $text_disabled; ?></option>
															<?php } else { ?>
																<option value="1"><?php echo $text_enabled; ?></option>
...
<script type="text/javascript" src="view/javascript/bossthemes/ckeditor.jquery.js"></script>
...
<script type="text/javascript"><!--
<?php foreach ($languages as $language) { ?>
$('#boss-aboutus-ckeditor<?php echo $language['language_id']; ?>').ckeditor();
$('#boss-contactus-ckeditor<?php echo $language['language_id']; ?>').ckeditor();
$('#boss-quicklink-ckeditor<?php echo $language['language_id']; ?>').ckeditor();
$('#boss-powered-ckeditor<?php echo $language['language_id']; ?>').ckeditor();
<?php } ?>
<!-- TABS -->
$('#mainTabs a').tabs();
$('#tabs0 a').tabs();
$('#tabscode a').tabs();
$('#aboutus-lang a').tabs();
$('#contactus-lang a').tabs();
$('#quicklink-lang a').tabs();
$('#powered-lang a').tabs();
$('#tabs01 a').tabs();
$('#tabs1 a').tabs();
$('#tabs2 a').tabs();
