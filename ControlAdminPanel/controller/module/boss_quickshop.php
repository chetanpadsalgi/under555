...
class ControllerModuleBossQuickshop extends Controller {
	...
	public function install() 
	{
		...
		foreach($languages as $language){
			$array_description{$language['language_id']} = 'Quick Shop';
		}
		$boss_quickshop = array('boss_quickshop_module' => array ( 
		0 => array ( 'array_class_selected' =>  ".product-list&gt;div, .product-grid&gt;div, .box-product&gt;div", 'text' => $array_description, 'width' => 1000, 'height' => 800, 'layout_id' => $this->getIdLayout("category"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		1 => array ( 'array_class_selected' =>  ".product-list&gt;div, .product-grid&gt;div, .box-product&gt;div", 'text' => $array_description, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("manufacturer"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		2 => array ( 'array_class_selected' =>  ".box-product&gt;div", 'text' => $array_description, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("product"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0),
		3 => array ( 'array_class_selected' =>  ".filtercontainer&gt;div", 'text' => $array_description, 'width' => 1000, 'height' => 800,'layout_id' => $this->getIdLayout("home"), 'position' => 'content_top', 'status' => 1, 'sort_order' => 0)
		));
